  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen">
      ...
      <nav className="bg-gray-800 p-4 flex justify-between items-center shadow-md">
        ...
        <div>
          <NavLink to="/signup" className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg">
            Sign Up
          </NavLink>
        </div>
      </nav>
      ...
      <div className="flex items-center justify-center min-h-[80vh]">
        ...
        >
          ...
          <p className="text-gray-400 text-center mb-6">Log in to continue your journey</p>
